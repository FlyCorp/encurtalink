...
class NpsApiController extends Controller
{
     ...
     *     path="/api/nps/update",
     *     tags={"NPS"},
     *     summary="Atualizar determinado NPS de uma campanha",
     *     description="Atualiza os dados de um NPS sem gerar um novo disparo",
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\MediaType(
     *             mediaType="application/json",
     ...
     *         ),
     *     ),
     *     @OA\Response(response="200", description="Nps atualizado com sucesso"),
     *     @OA\Response(response="422", description="Um ou mais campos inválidos")
     * )
     */
