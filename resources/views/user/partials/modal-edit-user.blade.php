                ...
                <form id="kt_modal_new_update_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    ...
                    <div
                        ...
                        <div class="col-lg-12 text-center">
                            <!--begin::Image input-->
                            <div id="image-avatar" class="image-input image-input-outline image-input-empty"
                            ...
                            <!--end::Image input-->
                            <!--begin::Hint-->
                            <div class="form-text text-danger">Tipos de arquivo permitidos: <b>png, jpg, jpeg</b>.
                            </div>
                            <!--end::Hint-->
                        </div>
                    </div>
