<div class="modal fade" id="kt_modal_configuration_link" tabindex="-1" aria-modal="true" role="dialog">
    <!--begin::Modal dialog-->
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_card_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    ...
                    <div
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" placeholder="chave"
                            name="key">
                    ...
                    <div
                        ...
                        <!--end::Label-->
                        <textarea class="form-control form-control-solid" rows="3" name="value"
                            placeholder="Informe o valor da chave"></textarea>
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Actions-->
