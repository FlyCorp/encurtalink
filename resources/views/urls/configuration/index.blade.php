...
@push('script')
    ...
    <script src="@version('assets/js/custom/pages/urls/configuration-table.js')" rel="script" type="text/javascript"></script>
@endpush
...
@section('content')
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-125px sorting" tabindex="0"
                                                    ...
                                                    style="width: 188.219px;">Chave</th>
                                                <th class="min-w-125px sorting" tabindex="0"
                                                    aria-controls="kt_subscriptions_table" rowspan="1" colspan="1"
                                                    aria-label="Billing: activate to sort column ascending"
                                                    style="width: 201.141px;">Descrição</th>
    ...
    @include('urls.configuration.partials.modal-create-config')
@endsection
