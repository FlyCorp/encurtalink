        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
          ...
          <form id="kt_modal_new_card_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" autocomplete="off">
            <div class="mb-13 text-center">
              <!--begin::Title-->
              <h1 class="mb-3">Nova configuração</h1>
              <!--end::Title-->
            </div>
            <!--begin::Input group-->
            <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
              ...
              <!--end::Label-->
              <input type="text" class="form-control form-control-solid" placeholder="" name="key">
            ...
            <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
              ...
              <!--end::Label-->
              <textarea class="form-control form-control-solid" rows="3" name="value" placeholder="Informe um valor"></textarea>
              <div class="fv-plugins-message-container invalid-feedback"></div>
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
